 ...
 */
public class DecommissionedDevices implements RequestHandler<APIGatewayProxyRequestEvent, APIGatewayProxyResponseEvent> {
    ...
    private String pvzGetDevices(){
        ...
        expressionAttributeValues.put(":val", new AttributeValue().withS("DECOMMISSIONED"));
